...
const Contact = () => {
    ...
    formData.append("access_key", "28829a8a-7528-4655-bde1-e7eb40ca51c1");
            ...
            <div className="contact-section">
                <div className="contact-left">
                    ...
                    <div className="contact-details">
                        ...
                        <div className="contact-detail">
                            <img src={call_icon} alt="" /> <p>+569-68995230</p>
                        </div>
                        <div className="contact-detail">
                            <img src={location_icon} alt="" /> <p>Santiago de Chile, Chile</p>
                        </div>
                    </div>
                </div>
